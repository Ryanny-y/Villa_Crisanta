...
const TeamCard = ({ team }) => {
  return (
    <div className="py-7 px-5 flex flex-col justify-between md:justify-start gap-3 basis-40 sm:basis-40 md:basis-48 max-w-48 md:max-w-60 flex-grow rounded-md text-center shadow-xl">
