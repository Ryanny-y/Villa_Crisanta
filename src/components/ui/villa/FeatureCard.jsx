...
const FeatureCard = ({ feature, description, imgs }) => {
  return (
    <div className="flex flex-col basis-52 max-w-60 sm:max-w-full gap-1 p-5 items-center text-center border rounded-sm border-black flex-1" data-aos="flip-left">
