...
const AmenitiesImgCard = ({ img, aos, path }) => {
  ...
  return (
    ...
    >
      <img src={`images/${path}/${img}.webp`} alt="Amenity Image" className={`h-full w-full ${imgLoaded ? 'opacity-100' : 'opacity-0'} transition-opacity duration-500`} loading='lazy'/>
    </div>
  )
}
