...
const AmenitiesImgCard = ({ img, aos }) => {
  ...
  return (
    <div className={`amenity-img-card flex-1 basis-52 max-w-80 h-72 p-5 shadow-lg ${ imgLoaded ? `bg-none` : `bg-[url('images/villa1/small/${img}.png')]`} bg-cover bg-center object-cover`} data-aos={aos}>
