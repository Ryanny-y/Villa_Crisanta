...
const GalleryImage = ({ order, setShowImg }) => {
  ...
  return (
    <div
      ...
      style={{
        background: `url(images/photo_gallery/${villaDetails.path}/small/gallery-${order}.png) no-repeat center / cover`,
      }}
    >
      <img
        data-aos={`${imgLoaded && "fade"}`}
        data-aos-duration="1000"
        src={`images/photo_gallery/${villaDetails.path}/gallery-${order}.webp`}
        alt="Gallery Img"
        className={`
