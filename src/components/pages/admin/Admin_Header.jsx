  ...
  return (
    <header className="px-5 xl:px-10 2xl:px-14 flex items-center py-3 border-b border-gray-400">
      <div className="left-side flex-grow flex items-center gap-12">
        ...
        <div className="flex items-center gap-2 py-1 px-5 bg-yellow-600 rounded-md text-light">
      ...
      <div className="search-bar relative justify-self-end basis-60 rounded-md bg-secondaryGray px-3 py-1">
