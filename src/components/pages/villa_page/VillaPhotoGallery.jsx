...
const VillaPhotoGallery = () => {
  ...
  return (
    <section id="villa-photo-gallery" className='mb-20 md:mb-16 lg:mb-12 pt-20 overflow-hidden'>
      <div className="container mx-auto  flex flex-col gap-10">
        <VillaHeaderTitle title="PHOTO GALLERY"/>

        {showImg && 
          <div 
          className="fixed top-0 left-0 right-0 bottom-0 z-50 flex items-center justify-center overflow-hidden"
        >
          <div
